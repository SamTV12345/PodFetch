...
export const AudioPlayer = ()=>{
    ...
    return <View style={{bottom: 10, marginLeft: 18, marginRight: 18, backgroundColor: styles.darkColor, display: 'flex', flexDirection: 'row', position: 'relative'}}>
        <View style={{width: '60%', backgroundColor: 'white', height: 2, position: 'absolute', borderTopLeftRadius: 20, borderTopRightRadius: 20}}></View>
        ...
        <View style={{position: 'absolute', right: 10, alignSelf: 'center', paddingTop: 10, display: 'flex', flexDirection: 'row', gap: 3}}>
            ...
            <AntDesign size={20} name="caretright" color="white"/>
        </View>
    </View>
