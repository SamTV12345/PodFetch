...
impl TagsPodcast {
    pub fn add_podcast_to_tag(tag_id_to_insert: String, podcast_id_to_insert: i32) ->
...
use crate::adapters::persistence::dbconfig::schema::tags_podcasts::dsl::*;
    ...
    pub fn delete_tag_podcasts(tag_id_to_delete: &str) -> Result<(),
        CustomError> {
        use crate::adapters::persistence::dbconfig::schema::tags_podcasts::dsl::*;
        use crate::adapters::persistence::dbconfig::schema::tags_podcasts::table as t_podcasts;
        use diesel::RunQueryDsl;
    ...
    pub fn delete_tag_podcasts_by_podcast_id_tag_id(podcast_id_to_delete: i32, tag_id_key: &str) ->
                                                                                                                                           Result<(),
        CustomError> {
        use crate::adapters::persistence::dbconfig::schema::tags_podcasts::dsl::*;
        use crate::adapters::persistence::dbconfig::schema::tags_podcasts::table as t_podcasts;
