...
impl DownloadService {
    ...
    pub fn download_podcast_episode(&mut self, podcast_episode: PodcastEpisode, podcast: Podcast) {
        ...
        let image_podcast_path = PathService::get_image_podcast_path(&podcast.directory.clone(),
                                                          &image_suffix);

        let image_save_path = PathService::get_image_path(&podcast.directory.clone(),
                                                          &podcast_episode.clone()
        ...
        create_dir(format!("podcasts/{}/{}", podcast.directory,
                           podcast_episode.episode_id)).expect("Error creating directory");
        ...
        self.db.update_total_podcast_time_and_image(&podcast_episode.episode_id,
                                               &image_save_path,
