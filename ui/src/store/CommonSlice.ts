...
interface CommonProps {
	...
	setInfoModalPodcast: (
		infoModalPodcast: components['schemas']['PodcastEpisodeDto'],
	) => void
...
const useCommon = create<CommonProps>((set, get) => ({
	...
	setInfoModalPodcastOpen: (infoModalPodcastOpen: boolean) =>
		set({ infoModalPodcastOpen }),
	...
	setDetailedAudioPlayerOpen: (detailedAudioPlayerOpen: boolean) =>
		set({ detailedAudioPlayerOpen }),
	setCurrentDetailedPodcastId: (currentDetailedPodcastId: number) =>
		set({ currentDetailedPodcastId }),
	setLoginData: (loginData: Partial<LoginData>) => set({ loginData }),
	setConfirmModalData: (confirmModalData: ConfirmModalProps) =>
		set({ confirmModalData }),
	setSelectedUser: (selectedUser: User) => set({ selectedUser }),
	setUsers: (users: components['schemas']['UserWithoutPassword'][]) =>
		set({ users }),
	setCreateInviteModalOpen: (createInviteModalOpen: boolean) =>
		set({ createInviteModalOpen }),
	...
	setPodcastAlreadyPlayed: (podcastAlreadyPlayed: boolean) =>
		set({ podcastAlreadyPlayed }),
	setPodcastEpisodeAlreadyPlayed: (podcastEpisodeAlreadyPlayed) =>
		set({ podcastEpisodeAlreadyPlayed }),
	tags: [],
