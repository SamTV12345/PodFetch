...
export const PlaylistData = ({name, onNameChange}: PlaylistDataProps)=>{
    ...
    return <div className="mb-6 rounded-xl border border-(--border-color) p-4">
        <div className="mb-3 text-sm text-(--fg-secondary-color)">
        ...
        <fieldset className="xs:contents mb-4">
            <label className="ml-2 text-sm text-(--fg-secondary-color)" htmlFor="playlist-name">{t('playlist-name')}</label>
