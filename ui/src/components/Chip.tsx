...
export const Chip: FC<ChipProps> = ({ index, children }) => {
	switch (index % 7) {
		case 0:
			return (
				<span className="p-px inline-block rounded-sm bg-linear-to-tl from-blue-500 to-violet-500">
		...
		case 1:
			return (
				<span className="p-px inline-block rounded-sm bg-linear-to-tl from-slate-600 to-slate-300">
		...
		case 2:
			return (
				<span className="p-px inline-block rounded-sm bg-linear-to-tl from-blue-700 to-cyan-500">
		...
		case 3:
			return (
				<span className="p-px inline-block rounded-sm bg-linear-to-tl from-red-600 to-orange-600">
		...
		case 4:
			return (
				<span className="p-px inline-block rounded-sm bg-linear-to-tl from-green-500 to-teal-500">
		...
		case 5:
			return (
				<span className="p-px inline-block rounded-sm bg-linear-to-tl from-gray-400 to-gray-100">
		...
		case 6:
			return (
				<span className="p-px inline-block rounded-sm bg-linear-to-tl from-zinc-800 to-zinc-700">
