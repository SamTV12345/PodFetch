...
export const EpisodeFormatModal: FC<InfoModalProps> = ({
	open,
	setOpen,
	children,
	heading,
	...
	return createPortal(
		...
		>
			<div
				className={`relative bg-(--bg-color) max-w-2xl p-8 rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,var(--shadow-opacity))] ${open ? 'opacity-100' : 'opacity-0'}`}
