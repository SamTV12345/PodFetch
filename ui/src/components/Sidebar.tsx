...
export const Sidebar = () => {
    ...
    return (
        <div className={`fixed md:static ui-sidebar-surface h-full px-6 py-8 transition-[left] w-72 z-20 ${sidebarCollapsed ? '-left-72' : 'left-0 ui-sidebar-shadow md:shadow-none'}`} id="primary-navigation" aria-label="Sidebar">
