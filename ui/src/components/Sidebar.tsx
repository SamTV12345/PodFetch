...
export const Sidebar = () => {
	...
	return (
		...
		>
			{/* Burger menu */}
			<div
				className="flex items-center justify-center fixed left-0 md:-left-16 top-0 bg-(--accent-color) hover:bg-(--accent-color-hover) cursor-pointer text-white h-16 w-16 rounded-br-lg shadow-[0_4px_16px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_16px_var(--color-mustard-500)] transition-all z-10"
				onClick={() => {
			...
			<ul className="flex flex-col gap-2">
				...
				<SidebarItem
					iconName="podcasts"
					path="podcasts"
					translationKey="all-subscriptions"
				/>
				<SidebarItem
					iconName="favorite"
					path="favorites"
				...
				<span className="display-only-mobile">
					<SidebarItem
						...
						translationKey="search-episodes"
					/>
				</span>
			</ul>
		</nav>
