...
export const Sidebar = () => {
    ...
    return (
        <div className={`fixed md:static bg-stone-950 h-full px-6 py-8 text-white transition-[left] w-72 z-30 ${sidebarCollapsed ? '-left-72' : 'left-0 shadow-[4px_0_16px_rgba(0,0,0,0.5)] md:shadow-none'}`} id="primary-navigation" aria-label="Sidebar">
