    ...
    return (
        <div className="flex flex-col gap-4 items-end">
            ...
            files.length === 0 &&
                <>
                    <div
                        className={`flex flex-col justify-center gap-2 border border-dashed ui-border cursor-pointer p-4 text-center rounded-lg h-40 w-full hover:ui-input-surface ${handleDropColor()}`}
            ...
            opmlUploading &&
                <div className="pt-4 pb-6 w-full">
                    <span className="block text-center text-sm ui-text">
